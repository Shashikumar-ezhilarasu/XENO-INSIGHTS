...
exports.CHANNEL_PROFILES = void 0;
exports.buildEventChain = buildEventChain;
exports.simulateDelivery = simulateDelivery;
exports.CHANNEL_PROFILES = {
    whatsapp: {
        deliveryRate: 0.94,
        openRate: 0.72,
        clickRate: 0.35,
...
function buildEventChain(profile) {
    const events = [];
...
async function fireCallbackWithRetry(url, payload, attempt = 1) {
    try {
...
function simulateDelivery(input, profile) {
